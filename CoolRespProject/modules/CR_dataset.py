...
Данный модуль предназначен для хранения умолчаний:
    ...
    8) Словарь ошибок и рекомендаций по их фиксу
...
time_budni = {0: '08:30 - 10:05', 1: '10:15 - 11:50', 2: '12:35 - 14:10',
              ...
              6: '19:35 - 21:05'}  # Да, это седьмая пара. Её не должно быть, но порой случается
...
time_vihod = {0: '08:30 - 10:05', 1: '10:15 - 11:50', 2: '12:00 - 13:40',
              ...
              6: '19:05 - 20:35'}  # Да, это седьмая пара. Её не должно быть, но порой случается


# Словарь для кодов ошибок, их места и рекомендации по фиксу
er_list = {'00': ['Всё ок',
                  'Фиксить не надо'],
           # 1x - серия ошибок загрузки файла
           '10': ['',
                  ''],
           # 2x - серия ошибок парсинга файла
           '20': ['',
                  ''],
           # 3x - серия ошибок анализа файла
           '30': ['',
                  ''],
           # 4x - серия ошибок форматирования файла
           '40': ['',
                  ''],
           # 5x - серия ошибок сохранения файла
           '50': ['',
                  '']
        }
