...
|     Элемент     |                          Назначение                              |
| :-------------: | :--------------------------------------------------------------: |
| __main__.py     | Основное приложение, подгружает в себя модули и макет интерфейса |
...
## В разработке.
- [ ] Мобильная версия для отслеживания расписания "на сегодня"
- [ ] Адаптивный интерфейс
- [ ] Сокращение названий предметов
- [ ] Перерисовка иконок
