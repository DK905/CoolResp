...
# Основа создана с помощью Qt Designer
...
""" Макетная часть """
from PyQt5.QtWidgets import QAction, QCheckBox, QComboBox, QDialog, QFrame, QGroupBox, QHBoxLayout, QLabel, QLineEdit, QListWidget, QMenu, QMenuBar, QMessageBox, QPushButton, QWidget
...
class AboutBox(QDialog):
    def __init__(self):
        ...
        self.title.setStyleSheet("background-color: 'white'; font: 30pt \'Bookman Old Style\'; text-align: 'center'")
...
class Ui_MainWindow(object):
    # Здесь объявляются объекты макета + их расположение
    ...
    # Здесь объявляются визуальные свойства объектов
