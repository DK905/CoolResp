...
"""
def fill_base(wb, parse, a_bd, tdt, grp2, grp3, days_names):
...
"""
def is_merge(cell_1, cell_2, merge_list):
...
Описание:
    Создаёт форматированное расписание

Аргументы:
    1) База парсинга
    2) База анализа
    3) Выбор подгруппы из 2-х
    4) Выбор подгруппы из 3-х
...
"""
def create_resp(parse, a_bd, grp2, grp3, days, interval, year):
    try:
        ...
        wb = fill_base(wb, parse, a_bd, times, grp2, grp3, days)
...
Описание:
    Выделена отдельно из-за диалога сохранения файла
